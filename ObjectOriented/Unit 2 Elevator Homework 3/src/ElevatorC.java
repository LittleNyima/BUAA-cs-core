...
public class ElevatorC extends Thread implements ElevatorType {
    ...
    ElevatorC(WaitQueue queue, String id) {
    ...
    private boolean movable() {
        if (floor == 4 && direction == -1) {
            return false;
        } else {
            return floor != 18 || direction != 1;
        }
    }

    private boolean changeable() {
        return this.floor >= 4 && this.floor <= 18 && this.floor % 2 == 0;
    }
