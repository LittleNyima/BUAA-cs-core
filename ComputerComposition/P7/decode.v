...
`define DECODE lb    = (opcode == 6'b100000);\
					...
					nop   = (iinstr == 32'h00000000) || ((opcode == 6'b000000) && (func == 6'b000000) && (rs_ == 5'b00000) && (rd_ == 5'b00000));\
					eret  = (iinstr == 32'h42000018);\
					mtc0  = (opcode == 6'b010000) && (rs_ == 5'b00100);\
					mfc0  = (opcode == 6'b010000) && (rs_ == 5'b00000);\
